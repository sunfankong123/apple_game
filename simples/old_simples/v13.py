...
def main():
    ...
    brick_random_x = random.randint(-2, 2)
    brick_random_y = random.randint(-2, 0)

    brickX = 8
    brickY = 18
    Brick(brickX + brick_random_x, brickY + brick_random_y, 0)
    Brick(brickX + 1 + brick_random_x, brickY + brick_random_y, 0)
    Brick(brickX + 2 + brick_random_x, brickY + brick_random_y, 0)
    Brick(brickX + brick_random_x, brickY + 1 + brick_random_y, 0)
    Brick(brickX + 1 + brick_random_x, brickY + 1 + brick_random_y, 1)
    Brick(brickX + 1 + brick_random_x, brickY + 1 + brick_random_y, 1)
    Brick(brickX + 2 + brick_random_x, brickY + 1 + brick_random_y, 0)
    Brick(brickX + brick_random_x, brickY + 2 + brick_random_y, 0)
    Brick(brickX + 1 + brick_random_x, brickY + 2 + brick_random_y, 0)
    Brick(brickX + 2 + brick_random_x, brickY + 2 + brick_random_y, 0)
