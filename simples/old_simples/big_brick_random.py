...
def main():
    ...
    terminal_key = True
    # stepsfile = open("stepsdata/stepsdata_depthjuki_170111/stepsdata3000000.txt", "a")
...
class Paddle(pygame.sprite.Sprite):
    ...
    def __init__(self, bricks, holes, angle, all):
        ...
        self.image, self.rect = load_image("kubota.png")
    ...
    def update(self):
        ...
        for event in pygame.event.get():  # User did something
            ...
            for brick in self.bricks:
                old_x = brick.rect.left / 64
                old_y = brick.rect.top / 64
                pygame.sprite.Group.remove(self.bricks, brick)
                pygame.sprite.Group.remove(self.alls, brick)
                a = pygame.sprite.spritecollide(brick, self.bricks, False)
            ...
            for hole in self.holes:
                old_x = hole.rect.left / 64
                old_y = hole.rect.top / 64
                pygame.sprite.Group.remove(self.holes, hole)
                pygame.sprite.Group.remove(self.alls, hole)
...
class Brick(pygame.sprite.Sprite):
    def __init__(self, x, y, level):
        ...
        if self.depth > 255:
            ...
            bar_score -= 10
            terminal_key = True
        self.image = pygame.Surface((64, 64), 0, 32)
