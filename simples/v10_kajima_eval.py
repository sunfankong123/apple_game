...
def main():
    ...
    Brick(3 + brick_x, 5 + brick_y, 2)
    Brick(4 + brick_x, 5 + brick_y, 2)
    Brick(4 + brick_x, 5 + brick_y, 1)
    Brick(5 + brick_x, 5 + brick_y, 1)
    Brick(4 + brick_x, 4 + brick_y, 1)
    Brick(4 + brick_x, 6 + brick_y, 1)
    """
    Brick(8, 6, 2)
    Brick(8, 6, 2)
    Brick(7, 6, 1)
            ...
            if bricks_collided:  # 衝突ブロックがある場合
                ...
                for brick in bricks_collided:  # 各衝突ブロックに対して
                    ...
                    if brick.rect.right > screen_x:
                        ...
                        self.rect.left = screen_x - self.rect.width - vx
                        # bar_score -= 5
                    if brick.rect.bottom > screen_y:
                        brick.rect.bottom = screen_y
                        self.rect.top = screen_y - self.rect.height - vy
                       #  bar_score -= 5
