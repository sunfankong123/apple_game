    ...
    def __init__(self, checkpoint_path="deep_q_pong_networks", playback_mode=False, verbose_logging=False):
        ...
        with tf.device('/gpu:0'):
            ...
            with tf.variable_scope('softmax_linear'):
                ...
                self.output_advantage = tf.add(tf.matmul(local3, self.weights6), self.biases6)
        ...
        with tf.device('/gpu:0'):
            ...
            with tf.variable_scope('target_softmax_linear'):
                ...
                self.target_output_advantage = tf.add(tf.matmul(target_local3, self.target_weights6),
                                                      self.target_biases6)
