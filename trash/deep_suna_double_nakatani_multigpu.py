...
class DeepSuna(AI_Player):
        ...
        with tf.device('/cpu:0'):
            ...
            for d in [0, 1]:
                with tf.device('/gpu:%d' % d):
                    with tf.variable_scope('conv1', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    with tf.variable_scope('conv2', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    with tf.variable_scope('conv3', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    with tf.variable_scope('local3', tf.get_variable_scope(), reuse=True) as scope:
                ...
                '''
                    ...
                    with tf.variable_scope('softmax_linear', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    self.readout_action = tf.reduce_sum(tf.multiply(self.output_layer[d], self._action[d]),
                                                        axis=1)
                    ...
                    with tf.variable_scope('target_conv1', tf.get_variable_scope(), reuse=True) as scope:
                        self.target_kernel1 = _variable_with_weight_decay('target_weights',
                                                                          shape=[8, 8, self.STATE_FRAMES,
                                                                                 32],
                                                                          stddev=0.01,
                                                                          wd=0.0)
                    ...
                    with tf.variable_scope('target_conv2', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    with tf.variable_scope('target_conv3', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    with tf.variable_scope('target_local3', tf.get_variable_scope(), reuse=True) as scope:
                    ...
                    with tf.variable_scope('target_softmax_linear', tf.get_variable_scope(), reuse=True) as scope:
    ...
    def get_keys_pressed(self, screen_array, reward, terminal, turn):
        with tf.device("/cpu:0"):
            ...
            if self._time % self.TARGET_NETWORK_UPDATE_FREQ == 0 and self._time != 0:
