...
class DeepSuna(AI_Player):
    ...
    def __init__(self, checkpoint_path="deep_suna_networks", playback_mode=False, verbose_logging=False):
        ...
        self.output_layer = resnet.inference(self._input_states, self._is_training)
        ...
        self.target_is_training = tf.placeholder('bool', [], name='is_training')
        self.target_output_layer = resnet.target_inference(self._target_input_states, self.target_is_training)
