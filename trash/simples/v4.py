...
def main():
    ...
    Hole(0, 0)
    """
    Brick(random.randint(1,2),random.randint(1,4))
    Brick(random.randint(3,4), random.randint(3, 4))
    Brick(random.randint(4,5), random.randint(2, 4))
    Hole(random.randint(5, 6), random.randint(8, 8))
    Hole(random.randint(7, 8), random.randint(5, 6))
    Hole(random.randint(8, 9), random.randint(7, 8))
    # スコアボードを作成
    score_board = ScoreBoard()

    # パドル
    paddle = Paddle(bricks, holes, score_board, all)
...
class Paddle(pygame.sprite.Sprite):
    """ボールを打つパドル"""
    def __init__(self, bricks, holes, score_board, all):
