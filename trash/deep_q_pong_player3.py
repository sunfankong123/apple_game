...
class DeepQPongPlayer(PongPlayer):
    ...
    INITIAL_RANDOM_ACTION_PROB = 0.5  # starting chance of an action being random
    ...
    def __init__(self, checkpoint_path="deep_q_pong_networks", playback_mode=False, verbose_logging=False):
        ...
        cost = tf.reduce_mean(tf.square(self._target - readout_action)/2)
        ...
        #self._saver.restore(self._session, "deep_q_pong_networks/network-300000")
