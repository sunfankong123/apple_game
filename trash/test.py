...
class DeepSuna(AI_Player):
    ...
    def __init__(self, checkpoint_path="deep_suna_networks", playback_mode=False, verbose_logging=False):
        ...
        self._last_state = np.zeros((self.STATE_FRAMES,
        ...
        self._input_states = tf.placeholder("float",
                                            [None, self.STATE_FRAMES, self.RESIZED_SCREEN_X,
    ...
    def get_keys_pressed(self, screen_array, reward, terminal, turn):
        ...
        if self.first_frame is True:
            ...
            compute_state = np.asanyarray(self._last_state.reshape(1, self.STATE_FRAMES,
        ...
        compute_state = np.asanyarray(current_state.reshape(1, self.STATE_FRAMES,
                                                            self.RESIZED_SCREEN_X, self.RESIZED_SCREEN_Y),
                                      dtype=np.float32)
