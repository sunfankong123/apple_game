...
from pygame.constants import K_DOWN, KEYDOWN, KEYUP, QUIT, K_RIGHT, K_LEFT, K_UP
...
class PyGamePlayer(object):
    ...
    def _on_screen_update(self, _, *args, **kwargs):
        ...
        reward, terminal, turn = self.get_feedback()
        keys = self.get_keys_pressed(surface_array, reward, terminal, turn)
    ...
    def _on_event_get(self, _, *args, **kwargs):
        ...
        # print key_up_events
        # print key_down_events
        # print self._keys_pressed
        result = []
